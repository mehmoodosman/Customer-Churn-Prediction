...
- If the customer has >=30% probability of churning, generate a short and brief explanation of why they are at risk of churning.
- If the customer has <30% probability of churning, generate a short and brief explanation of why they might not churn.
- Base your explanation on customer details, feature importances, and the summary statistics.

Avoid mentioning the top ten features, model, probability, or any model-specific terms in your explanation.
  """
...
def generate_email(probability, input_dict, explanation, surname):
    ...
    Make sure to list out a set of incentives to stay based on their information, in bullet points. Don't ever mention the probability of churning, or the machine learning model to the customer.
    """
...
if selected_customer_option:
  ...
  input_df, input_dict = prepare_input(creditscore, location, gender, age, tenure, balance, num_products, has_credit_card, is_active_member, estimated_salary)
  ...
  st.subheader("Personalised Email")
